    ...
    public class GeneralFederationController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            ...
            try
            {
                ...
                if (user)
                {
                    ModelState.AddModelError(string.Empty, "رقم هذا المستخدم موجود من قبل قم بإدخال رقم  مختلف");
                    return View(model);
                }
        ...
        private async Task<SelectDataCommuncationDropdownsVM> GetCommunicationDropdownsData(ApplicationUser currentUser)
        {
            ...
            return await _unitOfWork.CompalinteRepo.GetAddCommunicationDropdownsValues(subDirectoryId, directoryId, CollegesId, rolesString, rolesString);
        }
