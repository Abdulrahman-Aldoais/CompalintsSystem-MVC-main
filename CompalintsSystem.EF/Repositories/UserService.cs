    ...
    public class UserService : IUserService
    {
        ...
        public async Task AddBenefAsync(AddUserViewModel userVM, string currentName, string currentId)
        {
            ...
            var newUser = new ApplicationUser()
            {
                ...
                CollegesId = userVM.CollegesId,
                DepartmentsId = userVM.DepartmentsId,
                SubDepartmentsId = userVM.SubDepartmentsId,
            ...
            if (newUserResponse.Succeeded)
            {
                ...
                {
                    await _userManager.AddToRoleAsync(newUser, UserRoles.AdminColleges);
                }
                else if (userVM.userRoles == 3)
                {

                    await _userManager.AddToRoleAsync(newUser, UserRoles.AdminDepartments);
                }
                else if (userVM.userRoles == 4)
                {

                    await _userManager.AddToRoleAsync(newUser, UserRoles.AdminSubDepartments);
                }
        ...
        public async Task AddUserAsync(AddUserViewModel userVM, string currentName, string currentId)
        {
            ...
            if (newUserResponse.Succeeded)
            {
                ...
                {
                    newUser.UserRoleName = UserRolesArbic.AdminColleges;
                    newUser.RoleId = 2;
                    await _userManager.AddToRoleAsync(newUser, UserRoles.AdminColleges);
                }
                else if (userVM.userRoles == 3)
                {
                    newUser.UserRoleName = UserRolesArbic.AdminDepartments;
                    newUser.RoleId = 3;
                    await _userManager.AddToRoleAsync(newUser, UserRoles.AdminDepartments);
                }
                else if (userVM.userRoles == 4)
                {
                    newUser.UserRoleName = UserRolesArbic.AdminSubDepartments;
                    newUser.RoleId = 4;
                    await _userManager.AddToRoleAsync(newUser, UserRoles.AdminSubDepartments);
                }
        ...
        public async Task<IEnumerable<ApplicationUser>> GetAllAsync(string identityUser, int govId, int dirId, int subId)
        {
            ...
            || i.CollegesId == govId
            || i.DepartmentsId == dirId
            || i.SubDepartmentsId == subId
            )
        ...
        public bool IdentityNamberDoesNotHaveToBeDuplicate(string identity)
        {
            bool hasComplaint = _context.Users.Any(u => u.IdentityNumber == identity);
            return hasComplaint;
        }
        ...
        public async Task UpdateAsync(string id, EditUserViewModel entity)
        {
            ...
            else
            {
                ...
                updatedUser.CollegesId = entity.CollegesId;
                updatedUser.DepartmentsId = entity.DepartmentsId;
                updatedUser.SubDepartmentsId = entity.SubDepartmentsId;
                ...
                {
                    await _userManager.RemoveFromRolesAsync(updatedUser, roleId);
                    await _userManager.AddToRoleAsync(updatedUser, UserRoles.AdminColleges);
                }
                else if (entity.RoleId == 3)
                {
                    await _userManager.RemoveFromRolesAsync(updatedUser, roleId);
                    await _userManager.AddToRoleAsync(updatedUser, UserRoles.AdminDepartments);
                }
                else if (entity.RoleId == 4)
                {
                    await _userManager.RemoveFromRolesAsync(updatedUser, roleId);
                    await _userManager.AddToRoleAsync(updatedUser, UserRoles.AdminSubDepartments);
                }
